	...
	section.container-fluid
		header.row
			div.col-12.py-3.d-flex.flex-row.flex-wrap.align-items-center
				h2.pb-0.mb-0 Tout les devis
				nuxt-link.btn.btn-success.btn-sm.mx-3(:to="localePath({name: 'courses-add'})") Ajouter un nouveau devis
		div.row.p-3
...
import FieldsDef from "~/assets/data/devisHandle.js";
export default {
	components: {
		Vuetable,
		VuetablePagination
